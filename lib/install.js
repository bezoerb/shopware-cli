      ...
      task: () => {
        return new Listr([
          ...
          },
          {
            ...
            task: (ctx, task) => execa.stdout('git', ['submodule', 'add', submoduleUrl, 'shopware'])
          ...
          },
          {
            ...
            task: () => write(dir(submoduleTarget, 'config.php'), configPhp(options))
          },
          {
          ...
          },
          {
            ...
            task: () => write(dir(submoduleTarget, 'recovery', 'install', 'data', 'install.lock'), moment().format('yyyyMMddHHmm'))
          },
          {
