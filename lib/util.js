...
const clearCache = (flags = {}) => shopwareDir().then(base => {
  const tasks = new Listr([
    ...
    },
    {
      ...
      // The file "clear_cache.sh" isn't available in composer project https://github.com/shopware/composer-project
      enabled: () => fs.existsSync(path.resolve(base, 'var/cache/clear_cache.sh'))
    },
    {
